...
using System.IO;
//txtBaseUrl.Text + (txtBaseUrl.Text.EndsWith("/") ? "" : txtBaseUrl.Text + "/"), encryptedString);
//https://pgmorww11v.paigroup.corp/DDP.Web/Home/Sage300/?key=0QRHBeZ4CKGpik2KnBpNlUAwZ9aL9BVUaTpKqJE%2feCYTdYKw5NUVUhwiqvaZfHFkUrsK4vOVxDwGI0XUQVQ1deS6MyOdvktn2rhhaloVd0s1gYZRM6ZzVjeauIgMA9A%2fZ6gTd8qL2J7Bv54zJaHIeSA52Z2htxCTromBOrECGdVR7hPrqsQyCQ1%2f%2baqijq8pg37OtEK3IjDccLaVV7OgVkp1g4mifayGEyMB5qBfrQ0%3d
        ...
        private void txtLaunchDDP_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (rdoErp100.Checked)
                    ...
                    unencryptedString = txtCompanyCode.Text;
                ...
                string encryptedString = System.Web.HttpUtility.UrlEncode(Convert.ToBase64String(cipherBytes));
